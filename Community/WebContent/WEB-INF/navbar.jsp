	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="/Community/WEB-INF/viewCommunity.jsp">View Your Community</a></li>
				<li><a href="/Community/WEB-INF/residentList.jsp">Our Residents</a></li>
				...
				<li><a href="/Community/listComments">Neighbor Comments</a>
			</ul>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-expanded="false">About Us
						<span class="caret"></span>
					</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="/Community/listCommunities">Our Communities</a></li>
