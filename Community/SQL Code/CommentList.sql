...
SELECT COMMENTS.ID, USERS.USER_ID, USERS.USERNAME, COMMENTS.COMMENTTOPIC, COMMENTS.COMMENTCONTENT
FROM COMMENTS
INNER JOIN USERS
...
SELECT USERS.USERNAME, COMMENTS.COMMENTTOPIC, COMMENTS.COMMENTCONTENT FROM COMMENTS INNER JOIN USERS ON COMMENTS.USER_ID=USERS.USER_ID WHERE USERS.USER_ID = 1;
